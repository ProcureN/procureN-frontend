...
const Signup = () => {
  ...
  return (
    <div
      className='h-[200%] w-full items-center   justify-center bg-cover sm:h-screen md:flex '
    ...
    >
      <div className='p-4'>
        ...
        >
          {({ isSubmitting }) => (
            <Form className=' min-w-full rounded-3xl bg-white p-4  text-center md:p-6'>
              ...
              <div className='grid grid-cols-1 gap-2 sm:grid-cols-2 '>
                ...
                <div className=''>
                  ...
                  <ErrorMessage
                    name='email'
                    component='div'
                    className=' -mt-4 text-right text-sm text-red-700'
                  />
                  <Field
                    required
                    className='mb-6 w-full rounded-lg  border border-gray-300 px-4 py-2 placeholder:text-black focus:outline-none'
