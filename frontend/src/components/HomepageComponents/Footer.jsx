          ...
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptas, accusantium.
            ...
            <div className='grid grid-cols-1 gap-4 sm:grid-cols-3 lg:col-span-2 lg:grid-cols-3'>
              <div className='text-center md:text-left  '>
                ...
                <nav className='mt-2 flex list-none flex-col space-y-2 text-sm text-gray-500'>
                  <li>
                    <a
                      className='text-black hover:text-gray-800 hover:opacity-75'
                      href='#hero'
                    >
                      Home
                    </a>
              ...
              <div>
                ...
                <nav className='mt-2 flex flex-col space-y-2 text-center text-sm text-gray-500 md:text-left'>
                  ...
                  <span className='hover:opacity-75'>123456789</span>
                </nav>
              </div>
              {/* <div>
                ...
                <nav className='mt-4 flex flex-col space-y-2 text-sm text-gray-500'>
                  <a
                    className='text-indigo-500 hover:opacity-75 italic'
                    href='mailto:info@procuren.in'
                  >
                    info@procuren.in
                  </a>
