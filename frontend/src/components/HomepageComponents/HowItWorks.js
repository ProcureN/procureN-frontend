...
const HowItWorks = () => {
  ...
  return (
    <>
      ...
      <div className='md:text-md flex flex-col gap-4 text-center text-sm md:flex-row mb-6 md:mb-14'>
        ...
        <div className='flex w-full flex-col items-center text-white md:w-1/2 '>
          ...
          <div
            ...
            data-aos-delay='0'
            data-aos-duration='1000'
            className='mr-28 w-min whitespace-nowrap rounded-full border-2 border-white bg-[#5c67f5] px-6 py-8 transition-all duration-500 hover:z-10  '
          >
            Select your <br />
            product
          </div>
          ...
          <div
            ...
            data-aos-delay='0'
            data-aos-duration='1000'
            className='top-40 -mt-4 mr-28 w-min whitespace-nowrap rounded-2xl  border border-white bg-[#5c67f5] px-6 py-10 transition-all duration-500 hover:z-10  '
          >
            Receive response <br />
            to your enquiry
          </div>
          <div
            ...
            data-aos-delay='0'
            data-aos-duration='1000'
            className='top-60 -mt-8 ml-28 w-min whitespace-nowrap rounded-3xl  border border-white bg-[#cb67ac] px-8 py-12 transition-all duration-500 hover:z-10  '
          >
            Finalize the deal
          </div>
        </div>
